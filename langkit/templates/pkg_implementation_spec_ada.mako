...
private package ${ada_lib_name}.Implementation is
   ...
   type Analysis_Context_Type is limited record
      ...
      --  Number of recursive calls currently running, including:
      --
      --  * parsing functions;
      --  * properties calls;
      --  * lexical environment lookups;
      --  * populate lexical environment calls.
      --
      --  This counter is used as a mitigation against infinite recursions.
